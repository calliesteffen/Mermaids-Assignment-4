...
## a. Is there a significant difference between lobster size at MPA sites in 2012 and 2017? 
## b. Is there a significant difference between lobster size at non-MPA sites in 2012 and 2017? 
## c. Is there a significant difference between lobster size at MPA vs. Non-MPA sites in 2017? 

```{r}

#create data frames to perform statistical test to answer the questions above 
...
```{r}
####
#3a. Comparing lobster size at the two MPA sites (IVEE and NAPL) in 2012 and 2017
####
...
mpa_ttest <- mpa_sites %>%
  t.test(SIZE ~ YEAR, data =., var.equal = FALSE)

mpa_ttest

######
#RESULT: At the MPA sites, there is a significant difference between lobster size in 2012 and 2017
######
...
```{r}
###
#3b. Comparing lobster size at the non-MPA sites (CARP, MOHK, and AQUE) in 2012 and 2017
###
...
######
#RESULT: At the non-MPA sites, there is a significant difference between lobster size in 2012 and 2017
######
...
```{r}
###
#3c. Comparing lobster size at MPA vs. Non-MPA sites in 2017
###
