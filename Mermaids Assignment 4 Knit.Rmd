...
## a. Is there a significant difference between lobster size at each of the sites in 2012 and 2017? 


```{r}

#create data frames to perform statistical tests to answer the questions above 
...
```{r}
####
#3a. Comparing lobster size at ALL MPA sites (IVEE and NAPL) in 2012 and 2017
####
...
```{r}
###
#3b. Comparing lobster size at ALL non-MPA sites (CARP, MOHK, and AQUE) in 2012 and 2017
###
